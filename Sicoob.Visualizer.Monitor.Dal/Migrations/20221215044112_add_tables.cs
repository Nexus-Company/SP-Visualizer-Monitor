        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Directory = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: false, defaultValue: "None")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_Target_Type_Date",
                table: "Activities",
                columns: new[] { "Target", "Type", "Date" });
