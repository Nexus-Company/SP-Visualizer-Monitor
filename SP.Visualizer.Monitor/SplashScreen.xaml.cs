...
using SP.Visualizer.Monitor.Wpf.Views;
...
public partial class SplashScreen : Window
{
    ...
    public const string repo = "SP-Visualizer-Monitor";
 ...
 "SP Visualizer Service (Debug)";
    ...
    private async void Login()
    {
        ...
        await ChangeStatusAsync("Obtendo atualizações...");

        var ghClient = new GitHubClient(new ProductHeaderValue(repo, version));

        var versions = await ghClient.Repository.Release.GetAll("Nexus-Company", repo);
