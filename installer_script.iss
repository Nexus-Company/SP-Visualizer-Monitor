...
begin
  // https://dotnet.microsoft.com/download/dotnet/6.0
  if not Dependency_IsNetCoreInstalled('Microsoft.WindowsDesktop.App 6.0.12') then begin
    Dependency_Add('dotnet60desktop' + Dependency_ArchSuffix + '.exe',
      '/lcid ' + IntToStr(GetUILanguage) + ' /passive /norestart',
      '.NET Desktop Runtime 6.0.12' + Dependency_ArchTitle,
      Dependency_String('https://download.visualstudio.microsoft.com/download/pr/b11d3075-2191-4fe9-be05-e880f58d4577/3199263ba5d86952f5521f5e665e63bb/windowsdesktop-runtime-6.0.12-win-x86.exe', 'https://download.visualstudio.microsoft.com/download/pr/ba2ece7b-686a-4bda-b7d7-8cc3b8964d66/8eee13e44d90345d40c1b262c78aad6a/windowsdesktop-runtime-6.0.12-win-x64.exe'),
      '', False, False);
  end;
end;
...
#define UseNetCoreCheck true
#define UseSql2019Express true
#define UseVC2015To2022 true
#ifdef UseNetCoreCheck
  #define UseDotNet60Desktop true
#endif
...
Source: "Publish\*"; Excludes:  "appsettings.Development.json,*.pdb"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
#ifdef UseNetCoreCheck
...
;[Code]
;const
;  UninstSiteURL = 'https://nexus-company.tech/unistall';
